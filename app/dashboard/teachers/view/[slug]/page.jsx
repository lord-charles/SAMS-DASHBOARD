  ...
  return (
    <Card className='mx-5'>
        ...
        <div className="gap-5 grid sm:grid-cols-3 mt-6 text-sm">
            ...
            <div className=''>
                <p> Name</p>
                <p className='text-stone-500'>{data?.fullName}</p>
            </div>
            <div className=''>
                <p> Position</p>
            ...
            <div className=''>
                <p> Date of Birth</p>
                <p className='text-stone-500'>{new Date(data?.dateOfBirth)?.toLocaleString("en-us", options)}</p>
            </div>
            <div className=''>
                <p> National Number</p>
            ...
            <div className=''>
                <p> Active</p>
                <p className='text-stone-500'>{data?.active}</p>
            </div>
            <div className=''>
                <p> Work Status</p>
