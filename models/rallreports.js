...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('rallreports', {
    ID: {
      autoIncrement: true,
    ...
    fSDPActG: {
      ...
      allowNull: false,
      defaultValue: 0,
      comment: "Does the SDP include activities that benefit girls and other hard to reach students under all three categories 1) Physical Inputs, 2) Learning Quality and 3) General support?"
    },
    fFinRec: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "Are all financial records signed by the treasurer?"
    },
    fStoreRec: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "Is the store record\/assets register up-to-date and available for review?"
    },
    fBenefitGirls: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "Is there any evidence of the implementation of \/activities that benefit girls and other hard to reach students\/ stated in the SDP?"
    },
    fGovParEff: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "School Governance Partial Effectiveness"
    },
    fPESGESS: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "PES trained by GESS?"
    },
    fPESPSLP: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "fPESPSLP\tPES trained by PSLP?"
    },
    fBothSDPnBudget: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "Is there both an SDP and School Budget for the current year?"
    },
    fActForTranche: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "Has school accounted for the previous tranche?"
    },
    fRecentTPD: {
      type: DataTypes.DATEONLY,
      allowNull: false,
      defaultValue: "0000-00-00",
      comment: "Date of most recent TPD in school"
    },
    fClassrooms: {
      type: DataTypes.INTEGER,
      allowNull: false,
      defaultValue: 0,
      comment: "How many classrooms does the school have (permanent and semi-permanent)"
    },
    fDateLCLM1: {
      type: DataTypes.DATEONLY,
      allowNull: false,
      defaultValue: "0000-00-00",
      comment: "Date of LCLM training 1"
    },
    fDateLCLM2: {
      type: DataTypes.DATEONLY,
      allowNull: false,
      defaultValue: "0000-00-00",
      comment: "Date of LCLM training 2"
    },
    fRecPockLib: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "Has the school received the \/Pocket Library\/?"
    },
    fDatePartMDW: {
      type: DataTypes.DATEONLY,
      allowNull: false,
      defaultValue: "0000-00-00",
      comment: "Date school participated in Materials Development Workshop?"
    },
    fEvidActLib: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "Evidence of active school centre\/resource library?"
    },
    fEstGC: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "Has the school established a Girls Club?"
    },
    fDateLastMent: {
      type: DataTypes.DATEONLY,
      allowNull: false,
      defaultValue: "0000-00-00",
      comment: "Date of last teacher mentoring"
    },
    fDateLastPeer: {
      type: DataTypes.DATEONLY,
      allowNull: false,
      defaultValue: "0000-00-00",
      comment: "Date of last peer mentoring"
    },
    fSMCbyGESS: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "TSMC training by GESS?"
    },
    fMenByGESS: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "Mentoring by GESS?"
    },
    fTPDfocByGESS: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "TPD focus school by GESS?"
    },
    fPSLPheadTrain: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "PSLP Head Teacher training?"
    },
    fIncHGB: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: 0,
      comment: "Is the SMC\/BoG an inclusive body with Head Girl and Head Boy included as members?"
    },
    fLastObLess: {
      type: DataTypes.DATEONLY,
      allowNull: false,
      defaultValue: "0000-00-00",
      comment: "Date of last lesson observation"
    },
    fManyParts1Act: {
      type: DataTypes.INTEGER,
      allowNull: false,
      defaultValue: 0,
      comment: "How many of the participants have taken at least one action?"
    },
    fManyParts0Act: {
      type: DataTypes.INTEGER,
      allowNull: false,
      defaultValue: 0,
      comment: "How many of the participants have taken no action?"
    },
    fManyPartsSelTaken: {
      type: DataTypes.STRING(100),
      allowNull: false,
      defaultValue: "",
      comment: "What actions have the participants taken?"
    },
    fManyPartsOthTaken: {
      type: DataTypes.STRING(100),
      allowNull: false,
      defaultValue: "",
      comment: "What other actions have the participants taken?"
    },
    fManyPartsDisc: {
      type: DataTypes.INTEGER,
      allowNull: false,
      defaultValue: 0,
      comment: "How many of you have only talked to wider community members about what you have discussed here and nothing else?"
    }
  }, {
    sequelize,
    tableName: 'rallreports',
    timestamps: false,
    indexes: [
      {
        name: "PRIMARY",
